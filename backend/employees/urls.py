...
urlpatterns = [
    ...
    path('employee-work-experience/<str:employee>/<int:pk>/', EmployeeWorkExperienceView.as_view(), name='employee-work-experience'),
    ...
    path("my-work-experience/<int:pk>/", MyWorkExperienceView.as_view(), name="my-work-experience"),
