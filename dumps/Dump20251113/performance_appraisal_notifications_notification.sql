...
CREATE TABLE `notifications_notification` (
  ...
  PRIMARY KEY (`id`),
  KEY `notifications_notifi_employee_id_23bed844_fk_system_em` (`employee_id`),
  CONSTRAINT `notifications_notifi_employee_id_23bed844_fk_system_em` FOREIGN KEY (`employee_id`) REFERENCES `system_employee` (`id`)
