...
CREATE TABLE `attendance_attendanceevent` (
  ...
  `is_final_exit` tinyint(1) NOT NULL,
  `employee_id` varchar(5) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `attendance_attendanc_employee_id_69cbaac9_fk_system_em` (`employee_id`),
  CONSTRAINT `attendance_attendanc_employee_id_69cbaac9_fk_system_em` FOREIGN KEY (`employee_id`) REFERENCES `system_employee` (`id`)
