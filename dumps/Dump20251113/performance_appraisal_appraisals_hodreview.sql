...
--
-- Table structure for table `appraisals_hodreview`
--

DROP TABLE IF EXISTS `appraisals_hodreview`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `appraisals_hodreview` (
  ...
  CONSTRAINT `appraisals_hodreview_appraisal_id_d556fb62_fk_appraisal` FOREIGN KEY (`appraisal_id`) REFERENCES `appraisals_employeeappraisal` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `appraisals_hodreview`
--

LOCK TABLES `appraisals_hodreview` WRITE;
/*!40000 ALTER TABLE `appraisals_hodreview` DISABLE KEYS */;
/*!40000 ALTER TABLE `appraisals_hodreview` ENABLE KEYS */;
UNLOCK TABLES;
