...
--
-- Table structure for table `appraisals_ceoreview`
--

DROP TABLE IF EXISTS `appraisals_ceoreview`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `appraisals_ceoreview` (
  ...
  CONSTRAINT `appraisals_ceoreview_appraisal_id_01d47ead_fk_appraisal` FOREIGN KEY (`appraisal_id`) REFERENCES `appraisals_employeeappraisal` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `appraisals_ceoreview`
--

LOCK TABLES `appraisals_ceoreview` WRITE;
/*!40000 ALTER TABLE `appraisals_ceoreview` DISABLE KEYS */;
/*!40000 ALTER TABLE `appraisals_ceoreview` ENABLE KEYS */;
UNLOCK TABLES;
