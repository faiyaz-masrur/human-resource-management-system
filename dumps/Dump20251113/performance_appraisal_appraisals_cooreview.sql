...
--
-- Table structure for table `appraisals_cooreview`
--

DROP TABLE IF EXISTS `appraisals_cooreview`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `appraisals_cooreview` (
  ...
  CONSTRAINT `appraisals_cooreview_appraisal_id_61410329_fk_appraisal` FOREIGN KEY (`appraisal_id`) REFERENCES `appraisals_employeeappraisal` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `appraisals_cooreview`
--

LOCK TABLES `appraisals_cooreview` WRITE;
/*!40000 ALTER TABLE `appraisals_cooreview` DISABLE KEYS */;
/*!40000 ALTER TABLE `appraisals_cooreview` ENABLE KEYS */;
UNLOCK TABLES;
